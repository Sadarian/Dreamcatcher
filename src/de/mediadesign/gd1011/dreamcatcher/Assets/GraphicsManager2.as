...
import flash.geom.Rectangle;
    ...
    public class GraphicsManager2 extends AssetManager
	{
        ...
        public function GraphicsManager2():void
        {
            ...
            else
            {
                if(this[item+"_List"])
                {
                    /*
                     ...
                     {
                         for (var i:int=0;i<(this[item+"_List"][0] as DisplayObjectContainer).numChildren;i++)
                         {
                             ((this[item+"_List"][0] as DisplayObjectContainer).getChildAt(i) as AnimatedModel).reset();
                             ((this[item+"_List"][0] as DisplayObjectContainer).getChildAt(i) as AnimatedModel).start();
                         }
