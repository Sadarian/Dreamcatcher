package de.mediadesign.gd1011.dreamcatcher.Interfaces.Movement
{
    ...
    public class MovementVictim implements IMovement
    {
	    ...
	    private var minDirection:Number = GameConstants.victimDirectionBorders[1];
	    private var maxDirection:Number = GameConstants.victimDirectionBorders[0];
	    private var minMovementY:Number = GameConstants.victimMovementBorder[0];
	    private var maxMovementY:Number = GameConstants.victimMovementBorder[1];
